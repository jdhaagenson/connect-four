...
const addDiskToColumn = (event) => {
    ...
    switch (event.currentTarget) {
        case col1:
            console.log(col1.children[0])
            displayDisk(createDisk(), col1.children[columnCounter])
            columnCounter[0]--
            console.log(columnCounter[0])
            break;
        case col2:
            console.log(col2)
            displayDisk(createDisk(), col2)
            break;
        case col3:
            console.log(col3)
            displayDisk(createDisk(), col3)
            break;
        case col4:
            console.log(col4)
